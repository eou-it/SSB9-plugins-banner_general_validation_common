...
/**
 ...
 Generated: Mon Aug 01 12:03:42 IST 2011
 */
 ...
 */
/*PROTECTED REGION ID(functionrevenue_namedqueries) ENABLED START*/
...
class FunctionRevenue implements Serializable {
	...
	static constraints = {
	     ...
	     */
	    /*PROTECTED REGION ID(functionrevenue_custom_constraints) ENABLED START*/

	    /*PROTECTED REGION END*/
    }

    /*PROTECTED REGION ID(functionrevenue_readonly_properties) ENABLED START*/
     ...
     * from being overwritten on re-generation
     */
    /*PROTECTED REGION ID(functionrevenue_custom_attributes) ENABLED START*/
     ...
     * from being overwritten on re-generation
     */
    /*PROTECTED REGION ID(functionrevenue_custom_methods) ENABLED START*/
