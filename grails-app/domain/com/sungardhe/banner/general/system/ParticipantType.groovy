...
class ParticipantType implements Serializable {
    ...
    static constraints = {
         ...
         */
        /*PROTECTED REGION ID(participanttype_custom_constraints) ENABLED START*/

        /*PROTECTED REGION END*/
    }

    /*PROTECTED REGION ID(participanttype_readonly_properties) ENABLED START*/
     ...
     * from being overwritten on re-generation
     */
    /*PROTECTED REGION ID(participanttype_custom_attributes) ENABLED START*/
     ...
     * from being overwritten on re-generation
     */
    /*PROTECTED REGION ID(participanttype_custom_methods) ENABLED START*/
