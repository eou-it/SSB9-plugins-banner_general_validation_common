...
class AcademicCredentialsCompositeService {
    ...
    List<AcademicCredentials> list(Map params) {
        ...
        return params?.sort=='code'? academicCredentialsList : (params?.order.toUpperCase()==DEFAULT_ORDER_TYPE ? academicCredentialsList.sort{it.type} :academicCredentialsList.sort{it.type}.reverse())
    }
