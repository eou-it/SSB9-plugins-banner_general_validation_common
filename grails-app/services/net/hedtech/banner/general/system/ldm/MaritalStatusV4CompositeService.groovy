...
class MaritalStatusV4CompositeService extends AbstractMaritalStatusCompositeService {

    def getBannerMaritalStatusCodeToHedmMaritalStatusCategoryMap() {
        return getBannerMaritalStatusCodeToHedmMaritalStatusCategoryMap(GeneralValidationCommonConstants.MARITAL_STATUS_MARTIAL_CATEGORY, GeneralValidationCommonConstants.VERSION_V4)
    }
