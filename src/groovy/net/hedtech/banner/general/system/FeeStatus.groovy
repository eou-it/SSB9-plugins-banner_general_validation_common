...
class FeeStatus implements Serializable {
    ...
    @SequenceGenerator(name = "GTVFEES_SEQ_GEN", allocationSize = 1, sequenceName = "GTVFEES_SURROGATE_ID_SEQUENCE")
    @GeneratedValue(strategy = GenerationType.SEQUENCE, generator = "GTVFEES_SEQ_GEN")
    Long id
