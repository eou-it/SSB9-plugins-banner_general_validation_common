...
import com.sungardhe.banner.general.validation.common.Function
...
class FunctionIntegrationTests extends BaseIntegrationTestCase {
	...
	protected void setUp() {
		formContext = ['GTVFUNC'] // Since we are not testing a controller, we need to explicitly set this
		super.setUp()
	}
