...
class AcademicDisciplineV4CompositeServiceIntegrationTests extends BaseIntegrationTestCase{

    def academicDisciplineV4CompositeService
    ...
    void testGet() {
        ...
        def academicDiscipline = academicDisciplineV4CompositeService.get(academicDisciplines[0].id)
        // def academicDiscipline = academicDisciplineV4CompositeService.createAcademicDisciplineDataModel(dataMapAcademicDiscipline)
    ...
    void testGetWithInvalidGuid() {
        ...
        assertNotNull academicDisciplines[0].id
        try {
            academicDisciplineV4CompositeService.get(academicDisciplines[0].id + '2')
    ...
    void testGetWithNullGuid() {
        try {
            academicDisciplineV4CompositeService.get(null)
        } catch (ApplicationException ae) {
            assertApplicationException ae, "NotFoundException"
        }
    }
    ...
    void testGetWithEmptyGuid() {
        try {
            academicDisciplineV4CompositeService.get("")
        } catch (ApplicationException ae) {
            assertApplicationException ae, "NotFoundException"
        }
    }
    ...
    void testListWithInvalidSortFiled(){
        shouldFail(RestfulApiValidationException) {
            def map = [sort:'code']
            academicDisciplineV4CompositeService.listApi(map)
        }
    }
    ...
    void testListWithoutPaginationParams() {
        List academicDisciplines = academicDisciplineV4CompositeService.listApi([:])
        assertNotNull academicDisciplines
        assertFalse academicDisciplines.isEmpty()
    ...
    void testListWithPagination() {
        ...
        List academicDisciplines = academicDisciplineV4CompositeService.listApi(paginationParams)
        assertNotNull academicDisciplines
        assertFalse academicDisciplines.isEmpty()
    ...
    void testListWithoutPaginationParamsByMinorType() {
        List academicDisciplines = academicDisciplineV4CompositeService.listApi([type: AcademicDisciplineType.MINOR.value])
        assertNotNull academicDisciplines
        assertFalse academicDisciplines.isEmpty()
    ...
    void testListWithoutPaginationParamsByMajorType() {
        List academicDisciplines = academicDisciplineV4CompositeService.listApi([type: AcademicDisciplineType.MAJOR.value])
        assertNotNull academicDisciplines
        assertFalse academicDisciplines.isEmpty()
    ...
    void testListWithoutPaginationParamsByConcentrationType() {
        List academicDisciplines = academicDisciplineV4CompositeService.listApi([type: AcademicDisciplineType.CONCENTRATION.value])
        assertNotNull academicDisciplines
        assertFalse academicDisciplines.isEmpty()
    ...
    void testListWithInvalidType() {
        List academicDisciplines = academicDisciplineV4CompositeService.listApi([type: "INVALID_TYPE"])
        assertNotNull academicDisciplines
    ...
    void testListWithPaginationByMinorType() {
        ...
        List academicDisciplines = academicDisciplineV4CompositeService.listApi(params)
        assertNotNull academicDisciplines
        assertFalse academicDisciplines.isEmpty()
    ...
    AcademicDiscipline createAndTestAcademicDiscipline(Map i_success_input_content){
        Map dataMap = academicDisciplineV4CompositeService.create(i_success_input_content)
        AcademicDiscipline academicDiscipline = academicDisciplineV4CompositeService.createAcademicDisciplineDataModel(dataMap)
        assertNotNull academicDiscipline
    ...
    void testCreateAcademicDisciplineWithoutMandatoryCode() {
        ...
        try {
            academicDisciplineV4CompositeService.create(i_success_input_content)
        } catch (Exception ae) {
    ...
    void testUpdateAcademicDisciplineExistingGuidAndCodeWithNewTitle() {
        ...
        def o_success_AcademicDiscipline_update = academicDisciplineV4CompositeService.update(update_content)
    ...
    void testUpdateAcademicDisciplineWithInvalidGuid() {
        ...
        shouldFail(ApplicationException) {
            academicDisciplineV4CompositeService.update(update_content)
        }
    }
